...
| <a id="hw-i-013"></a>HW-I-013 — service/handling collaboration | Maintainer/handler procedures ↔ HC-VEHICLE and HC-PACK | IF-A-008, IF-A-011, IF-A-013 | Applies prescribed remove/refit, inspection and isolation procedures. Human action is not a sensed hardware state; no new interlock, sensor, programming connector or BMS-write capability follows. |
