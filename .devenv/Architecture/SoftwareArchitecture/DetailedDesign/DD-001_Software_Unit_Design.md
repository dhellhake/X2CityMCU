...
| `U-TRACTION-CONTROL` | [SC-TRACTION-CTRL](../TractionControl/DetailedDesign/TractionControl_Detailed_Design.md) | Hall-sensored FOC current regulation, `PWMAndADCSamplingPlanV1` production and output/energy observation, internal traction realization | UR-TRACTION-CONTROL-001 |
