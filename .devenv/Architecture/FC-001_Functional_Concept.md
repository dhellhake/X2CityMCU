...
Required self-tests and detection are distributed across the functions providing observations or physical effects. F-003 owns riding-session inhibition and F-009 coordinates vehicle and pack energy protection; F-019 reports their state. No single diagnostic display or policy function supplies all fault coverage. Known valid-code aliases, shared references, BMS group/probe limitations and physical output faults remain in the fault envelope even when observation cannot distinguish them.
...
|---|---|
| VS-001 / VS-010 — isolated or controlled energized service | F-018 establishes the task's actual power/access conditions with F-009/014, including stored/generated energy. F-019 distinguishes observations from permissions. Energized diagnostics are not normal riding or new riding authority. |
