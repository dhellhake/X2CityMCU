...
**Draft revision 1.7 — 2026-09-13**, based on approved **DEC-001-R1.0**. Adds owner-selected separate mobile charger placement (DEC-ARCH-001) and records the evidence gates for the REQ-001-R1.8 technical refinements. Earlier decisions retain their status; their reviewed requirement elaborations remain approved through REQ-001-R1.8. This working decision document is not released, and owner confirmation does not establish physical verification.
...
| `WS-OI-020` | System-requirements completion points and allocation | **A RELEASED — REQ-001-R1.6, 2026-09-11:** owner confirmed review of all System Requirements and instructed release; [release record](README.md#req-001-r16-system-requirements-release). **R1.8 RELEASED — 2026-09-13:** owner reviewed and released eight single-target HSI refinements and one retained-mechanics refinement; [release record](README.md#req-001-r18-technical-hsi-requirements-release). Their electrical endpoint, reset/retention, output/protection, donor-mechanics and timing/qualification evidence gates remain. The 12 earlier FSC rows remain Draft. **B remains OPEN:** [ARCH-001/002/003](../Architecture/ARCH-001_System_Architecture.md) are released as ARCH-001/002/003-R1.0, approving the initial logical/HW/SW decomposition, component interfaces and local vehicle/charger host roles. Complete requirement refinements/parent coverage, numerical contracts, protection/measurement mechanisms and component/host acceptance. The 180 active approved requirements, current Type/Target assignments and planned acceptance are approved with their controlled parameters. Source documents retain separate statuses; physical feasibility, diagnostic/protection and verification gates remain. This issue stays open for B. |
